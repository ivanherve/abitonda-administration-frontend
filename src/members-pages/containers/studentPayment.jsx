...
import { Table, ProgressBar, Tab, Row, Col, Nav, OverlayTrigger, Tooltip, Button } from "react-bootstrap";
        ...
        <div>
            {
                filtred
                    ?
                    <Button variant="outline-secondary" onClick={() => toDisplay()}>Tout afficher</Button>
                    :
                    <Button variant="outline-info" onClick={() => toFilter()}>Filtrer les trimestres payé</Button>
            }
            <hr />
...
const formatRWF = (num) => {
    return (num).toLocaleString("da-DK", { style: "currency", currency: "RWF", minimumFractionDigits: 0 });
}
