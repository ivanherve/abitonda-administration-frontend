            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    ...
                    <NavDropdown title="Activités Parascolaires" id="basic-nav-dropdown">
                        <NavDropdown.Item href="/activity/swimmingpool" disabled>Piscine</NavDropdown.Item>
                        <NavDropdown.Item href="/activity/karate" disabled>Karaté</NavDropdown.Item>
                        <NavDropdown.Item href="/activity/dance" disabled>Dances Traditionelles</NavDropdown.Item>
                        <NavDropdown.Item href="/activity/music" disabled>Musique</NavDropdown.Item>
                    </NavDropdown>
                    <Nav.Link href="/employees">Employés</Nav.Link>
                    <Nav.Link href="/birthdays">Anniversaires</Nav.Link>
                    <Nav.Link href="/statistic">Statistiques</Nav.Link>
