            ...
            <ListGroup variant="flush">
              {busData.map(line => (
                <ListGroup.Item
                  ...
                  variant={(line.nbStudents > line.maxPlaces) ? "danger" : (line.nbStudents === line.maxPlaces) ? "warning" : "light"} // Rouge si plein, orange si presque plein
                >
                  ...
                  <div className="d-flex flex-column flex-md-row align-items-md-center gap-4">
                    <div>
                      ...
                      <div className="text-muted small lh-sm">
                        ...
                        <div><span className="fw-semibold"><u>Nombre de place</u> :</span> {selectedLine.maxPlaces}</div>
                      </div>
                    </div>
                  </div>
                </Col>
