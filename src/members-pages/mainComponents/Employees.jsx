...
const numbFormat = number => {
    ...
    let format = new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(numb);
    return format;
}

export default function Employees(props) {
    const emp = [
        { EmployeeId: 1, Name: 'Hategekimana', Firstname: 'Protais', Account: '0130-2043600', Bank: 'COGEBANK', SalaireNet: '100000', SalaireBrut: '', Avance: '7000', Difference: '93000', Position: 'Chauffeur/Coursier', NbDays: 22, NbRSSB: '', Doc: '' },
        { EmployeeId: 2, Name: 'Irakoze', Firstname: 'Belyse', Account: '00048-06790820-06', Bank: 'BK', SalaireNet: '200000', SalaireBrut: '', Avance: '48500', Difference: '151000', Position: 'Enseignante', NbDays: 22, NbRSSB: '', Doc: '' },
        { EmployeeId: 3, Name: 'Bahati', Firstname: 'Sophia', Account: '00040-65000020-29', Bank: 'BK', SalaireNet: '100000', SalaireBrut: '', Avance: '3500', Difference: '96500', Position: 'Assistante Crèche', NbDays: 22, NbRSSB: '', Doc: '' },
        { EmployeeId: 4, Name: 'Kayumba', Firstname: 'Leaty', Account: '00002-01390241612-83', Bank: 'COGEBANK', SalaireNet: '300000', SalaireBrut: '', Avance: '68500', Difference: '231500', Position: 'Responsable Adm et Fin', NbDays: 22, NbRSSB: '10216978', Doc: '' },
    ];
            ...
            <Row>
                <Col xs='2'>
                    <ListGroup>
                        {
                            emp.map(e =>
                                <ListGroup.Item action key={emp.indexOf(e)} onClick={() => selectEmployee(e)}>
                                    {e.Name.toUpperCase() + ' ' + e.Firstname}
                                </ListGroup.Item>
                            )
                        }
                    </ListGroup>
                        ...
                        <Card.Body>
                            <Form>
                                ...
                                <Form.Group as={Row} controlId="formPlaintextSNet">
                                    ...
                                    <Col sm="10">
                                        <Form.Control plaintext readOnly defaultValue={numbFormat(sNet)} />
                                    </Col>
                                </Form.Group>
                                ...
                                <Form.Group as={Row} controlId="formPlaintextDifference">
                                    ...
                                    <Col sm="10">
                                        <Form.Control plaintext readOnly defaultValue={difference} />
                                    </Col>
                                </Form.Group>
