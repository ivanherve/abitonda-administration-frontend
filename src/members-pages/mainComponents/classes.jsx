            ...
            <Row>
                <Col xs='2'>
                    <ListGroup>
                        {
                            classes.map(c =>
                                <ListGroup.Item action key={classes.indexOf(c)} onClick={() => setSelectedClasse(c)}>
                                    {c}
                                </ListGroup.Item>
                            )
                        }
                ...
                <Col>
                    ...
                    <Card>
                        <Card.Header>
                            <Nav justify variant="tabs" defaultActiveKey="link-0" onSelect={e => e.length > 0 ? setLink(e) : setLink('link-0')}>
                                <Nav.Item>
...
function Links(props) {
    if (props.link === 'link-0') {
        ...
        return (
            <Informations classe={props.classe} />
        )
    }
    else {
        return (
                        ...
                        students.length > 0
                            ...
                            students.map(s =>
                                <tr key={students.indexOf(s)}>
                                    <td><strong>{s.Lastname}</strong> <i>{s.Firstname}</i></td>
                                    <td>
                                        <input type="checkbox" />
                                    </td>
                                </tr>
